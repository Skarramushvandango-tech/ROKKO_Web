...
export interface Release {
  cover: string;      // großes Cover (Detailansicht)
  coverMini: string;  // kleines Cover (Thumbnail / Voransicht)
  picture: string;    // Künstlerbild
  tracks: Track[];
}

export interface Artist {
  name: string;
  image: string;      // Künstlerbild für Übersichten
...
export const artists: { [key: string]: Artist } = {
  ...
  henribellieu: {
    ...
    releases: {
      lafemme: {
        cover: "/images/cover/henribellieuc over/la_femme.png",
        coverMini: "/images/cover/henribellieuc over/femme_mini.png",
      ...
      petitecolibri: {
        cover: "/images/cover/henribellieuc over/petite_colibri.png",
        coverMini: "/images/cover/henribellieuc over/petite_mini.png",
        picture: "/images/pictures/henri/henri.png",
        tracks: [
